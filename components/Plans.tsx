...
const Plans= () => {
    ...
    return (
        <div className="flex flex-col items-center text-2xl lg:text-3xl md:border-2 border-black bg-white p-5 lg:p-10  md:shadow-[2px_3px_1px_1px_rgba(0,0,0)] rounded-md">
            ...
            <p className='my-4 lg:my-6 lg:text-4xl'>Just &#8381; {plan === 'month' ? 800 : 8000} / {plan}</p>
            <Link href={`/pricing/${plan}`} className='bg-blue px-4 lg:px-6 lg:py-4 py-2 mt-6 lg:mt-8 text-white rounded-md'>Byu now</Link>
        </div>
    )
}
